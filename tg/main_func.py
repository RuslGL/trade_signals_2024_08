            ...
            if not res:
                ...
                await bot.send_message(
                    ...
                    text='🔴 Вы включаете режим торговли фьючерсами, сейчас будут применены рекомендуемые настройки плечей к вашему аккаунту на бирже.'
                         ...
                         '\n\nТакже после применения рекомендуемых настроек плечей вы сможетее изменить этот параметр в меню настройки'
                         '\n\n🔴   🔴   🔴'
                ...
                try:
                    ...
                    text_1 = "🟢  Изменения применены для основного и демо-акканута!"
                except:
                    text_2 = ("🟢  Изменения применены только для основного акканута!"
