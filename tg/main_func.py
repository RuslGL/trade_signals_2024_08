...
async def change_setting(callback_query):
    ...
    if  action == 'settings_spot':
        ...
        text = (f'🟢  Эта настройка определяет на каком рынке осуществляется торговля - на спотовом или фьючерсном'
                f'\n\n Текущая настройка {t}'
                f'\n\n🔴  Хотите изменить?'
                f'\n\n При включении торговли фьючерсами будут изменены ваши торговые настройки на аккаунте биржи. Это может занять время до 20 секунд. Придется подождать')
    ...
    if  action == 'settings_min_trade':
        ...
        text = ('🟢 Начальный размер позиции определяет на какую сумму будут приобретаться монеты (спот) или открываться позиция (фьючерс).'
                ...
                '\n\n🔑  Если вы хотите изменить настройку Минимальный размер позиции'
                '\nотправьте следующим сообщением фразу Минимальный размер позиции и сумму в USDT, которую хотите установить как настройку'
                '\n\n🟢 ПРИМЕР:'
                '\nМинимальный размер позиции 50'
    ...
    if  action == 'settings_max_trade':
        ...
        text = ('🟢 Максимальный размер позиции определяет максимальную сумму, на которую могут приобретаться монеты (спот) или открываться позиция (фьючерс) с учетом укрупнений.'
                ...
                '\nотправьте следующим сообщением фразу Максимальный размер позиции и сумму в USDT, которую хотите установить как настройку'
                '\n\n🟢 ПРИМЕР:'
                '\nМаксимальный размер позиции 500')
    ...
    if  action == 'settings_averaging_size':
        ...
        text = ('🟢 Шаг укрупнения'
                ...
                '\nотправьте следующим сообщением фразу Шаг укрупнения и число, которое вы хотите установить'
                '\n\n🟢 ПРИМЕР:'
                '\nШаг укрупнения 1.5')
    ...
    if  action == 'settings_averaging_step':
        ...
        text = ('🟢 Условия укрупнения'
                ...
                '\n\n Настройка условия укрупнения определяет насколько должна изменить цена, чтобы состоялось укрупнение'
                '\n\n Если цена изменилась недостаточно, то укрупнение не осуществляется'
                '\n\n🔑  Если вы хотите изменить настройку Условия укрупнения'
                '\nотправьте следующим сообщением фразу Условия укрупнения и число в процентах, которое вы хотите установить'
                '\n\n🟢 ПРИМЕР:'
    ...
    if  action == 'settings_tp_min':
        ...
        text = ('🟢 Условия открытия тейк-профита при движении цены в нужном направлении'
                ...
                '\nотправьте следующим сообщением фразу Тейк профит и число в процентах, которое вы хотите установить'
                '\n\n🟢 ПРИМЕР:'
                '\nТейк профит 2%')
